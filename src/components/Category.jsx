...
function Category() {
  return (
    <div className="flex justify-center my-2 mx-0">
      <NavLink
        to={"/cuisine/Italian"}
        className="flex flex-col justify-center items-center rounded-[50%] mr-8 bg-gradient-to-r from-[#494949] to-[#313131] w-24 h-24 cursor-pointer transform scale-90 focus:gradient"
      >
